...
import gitHubIcon from '../assets/icons/gh-icon-40px-50op.svg';
import linkedInIcon from '../assets/icons/li-icon-40px-50op.svg';
import twitterIcon from '../assets/icons/tw-icon-40px-50op.svg';
